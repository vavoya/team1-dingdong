      ...
      children: [
        {
          index: true,
          lazy: async () => {
            const [{ default: LoginHomeScreen }] = await Promise.all([import("@/pages/Auth/LoginHome/index.tsx")]);
        ...
        },
        {
          path: "login",
          lazy: async () => {
            const [{ default: Login }] = await Promise.all([import("@/pages/Auth/Login/index.tsx")]);
        ...
        },
        {
          path: "/signup",
          lazy: async () => {
            const [{ default: SignupLayout }] = await Promise.all([import("@/pages/Auth/Signup/page")]);
        ...
        },
        {
          path: "",
          lazy: async () => {
            const [{ default: SocketLayout }] = await Promise.all([import("@/pages/SocketLayout/layout.tsx")]);
          ...
          children: [
            ...
            },
            {
              ...
              lazy: async () => {
                const [{ default: SetHomeLocation }, { createLoader }] = await Promise.all([
            ...
            },
            {
              ...
              lazy: async () => {
                ...
                return {
                  ...
                  loader: createLoader(() => [usersModule.users_me(), usersModule.users_home_locations()]),
                };
              },
            },
            {
              ...
              lazy: async () => {
                const [{ default: FixedRouteBookingSelectBus }, { fixedRouteBookingLoader }] = await Promise.all([
                  import("@/pages/BusBooking/FixedRouteBookingSelectBus/page.tsx"),
                  import("@/route/loader/fixedRouteBooking/fixedRouteBookingLoader"),
                ]);
                return {
            ...
            },
            {
              ...
              lazy: async () => {
                ...
                const usersModule = await import("@/api/query/users");
                const fixedBookingLoader = await import("@/api/query/fixedBusBooking");
                return {
                  Component: FixedRouteBooking,
                  loader: createLoader(() => [
                    usersModule.users_me(),
                    usersModule.users_home_locations(),
                    fixedBookingLoader.fixedBooking(),
                  ]),
                };
              },
            },
            {
              path: "bus-tracker",
              lazy: async () => {
                const [{ default: BusTrackerPage }, { default: busTrackerLoader }] = await Promise.all([
            ...
            },
            {
              path: "reservations",
              lazy: async () => {
                const [{ default: ReservationsPage }, { default: ReservationsLoader }] = await Promise.all([
              ...
              children: [
                {
                  path: "reservation",
                  lazy: async () => {
                    const [{ default: PaymentReservationPage }, { default: paymentReservationLoader }] =
                      await Promise.all([
                ...
                },
                {
                  path: "purchase",
                  lazy: async () => {
                    const [{ default: PaymentPurchasePage }, { default: paymentPurchaseLoader }] = await Promise.all([
                ...
                },
                {
                  path: "success",
                  lazy: async () => {
                    const [{ default: PaymentSuccessPage }] = await Promise.all([
            ...
            },
            {
              path: "my-page",
              lazy: async () => {
                const [{ default: MyPage }, { createLoader: createLoader }] = await Promise.all([
                  import("@/pages/MyPage/page.tsx"),
                  import("@/route/loader/createLoader.tsx"),
                ]);
                const usersModule = await import("@/api/query/users");
                return { Component: MyPage, loader: createLoader(() => [usersModule.users_me()]) };
              },
            },
            {
              // 시간표 관리 페이지
              ...
              lazy: async () => {
                const [{ default: TimetableManagementPage }, { createLoader: createLoader }] = await Promise.all([
                ...
                return {
                  ...
                  loader: createLoader(() => [usersModule.users_timetable()]),
                };
              },
            },
            {
              ...
              path: "wallet",
              lazy: async () => {
                const [{ default: Wallet }, { createLoader: createLoader }] = await Promise.all([
