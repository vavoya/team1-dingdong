  ...
  [
    {
      ...
      children: [
        ...
        },
        {
          path: "notification",
          lazy: async () => {
            const [{ default: Notification }, { createLoader }] =
              await Promise.all([
          ...
          children: [
            {
              index: true,
              lazy: async () => {
                const [{ default: SchoolAuthSignUp }, { createLoader }] =
                  await Promise.all([
                    import("@/pages/Auth/Signup/SchoolAuth/index.tsx"),
                    import("@/route/loader/createLoader.tsx"),
                  ]);
                const schoolModule = await import(
                  "@/api/query/signUp/index.ts"
                );
                return {
        ...
        },
        {
          ...
          lazy: async () => {
            const [{ default: CustomRouteBooking }, { createLoader }] =
              await Promise.all([
        ...
        },
        {
          ...
          lazy: async () => {
            const [{ default: FixedRouteBooking }, { createLoader }] =
              await Promise.all([
        ...
        },
        {
          ...
          lazy: async () => {
            ...
            return {
              Component: MyPage,
              loader: createLoader(() => [usersModule.users_me()]),
            };
          },
        },
        {
          ...
          lazy: async () => {
            const [
              { default: TimetableManagementPage },
